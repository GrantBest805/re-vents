		...
		<Segment>
			...
			{providerId && providerId === 'password' && (
				<div>
					...
					<Form onSubmit={handleSubmit(updatePassword)}>
						...
						<Divider />
						<Button disabled={invalid || submitting} size='medium' positive content='Update Password' />
					</Form>
				</div>
			)}
			...
			{providerId && providerId === 'google.com' && (
				<div>
					...
					<p>Please visit Google to update your accout settings</p>
					<Button type='button' size='medium' color='google plus'>
